...
class Objects_Handler():
    ...
    def create_player(self):
        m, n = self.game.game_world.player_starting_coordinates
        player_tile = self.game.game_world.map2D[m][n]
        key = 'fighter'
    ...
    def populate_game_items(self):
        ...
        for item in data.level_design.game_items:
            ...
            for _ in range(number_of_objects):
                tile = self.game.game_world.get_random_room_floor_tile_with_no_objects()
